          ...
          >
            ...
            >
              <Typography
                ...
                variant="body1">
                Listen, strange women lyin’ in ponds distributin’ swords is no system for a basis of government. Supreme executive power derives from a mandate from the masses,
                not from some farcical aquatic ceremony. Are you suggesting coconuts migrate? Well, now, uh, Launcelot, Galahad, and I wait until nightfall, and then leap out of
                the rabbit, taking the French by surprise—not only by surprise but totally unarmed!
                <br></br>
                <br></br>
                We dine well here in Camelot. We eat ham and jam and Spam a lot. Well, don’t. It’s just like those miserable psalms, always so depressing. You don’t frighten us
                with your silly knees-bent running around advancing behavior! You must return here with a shrubbery. Or else you will never pass through these woods—alive.
              </Typography>
            ...
            {showFeedbackSection && (
              ...
              >
                ...
                >
                  ...
                  <Rating defaultValue={randomScore} max={4} />
                </Box>
                {/* Subsection 2 */}
                <Box>
